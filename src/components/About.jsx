  ...
  return (
    <>
      <div className="w-full flex flex-col items-center justify-center mt-10 p-4 lg:hidden ">
        <p className="self-start  lg:text-[13px] text-[10.5px] lg:text-base text-[#6A6A6A]">ABOUT</p>


        <p className="uppercase text-justify mt-10 p-4 text-base lg:text-lg text-[#6A6A6A] ">
          {" "}
          &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; Computer
        ...
        <p className="self-start lg:text-[13px] text-[10.5px] text-[#6A6A6A] uppercase mt-14">
          Skills
        </p>

        <div className="w-full px-4 flex justify-between text-[28px] text-[#1C1C1C] mt-10 items-center gap-2">
          <p>UI / UX</p>
          <hr className="flex-1 h-[0.5px] bg-[#6A6A6A] border-0" />
          <p>LOGO DESIGN</p>
        </div>

        <div className="w-full px-4 text-[28px] text-[#1C1C1C] ">
...
{/* PC screen */}
      <div className="w-full  flex-col items-center justify-center mt-10  px-20 hidden lg:flex ">
        <div className="w-full  flex justify-between items-start mt-16">
          ...
          <p className="self-start text-sm lg:text-base text-[#6A6A6A] text-[13px] w-1/3">
            ABOUT
          </p>
          ...
          <p className="uppercase text-justify w-1/3  text-base lg:text-[16px] text-[#6A6A6A]  max-w-sm">
            &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; Computer
